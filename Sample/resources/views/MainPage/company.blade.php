...
<span class="look">&lt;title&gt;クールイメージビジネスサイトサイト向け 無料ホームページテンプレート tp_cool7&lt;/title&gt;</span><br>
を編集しましょう。<br>
...
<p>fixmenu_pagetop.jsで動作の制御を、style.cssの「/*PAGE TOP（↑）設定」ブロックでボタンデザインを設定しています。<br>
ボタンの出現ポイントは、現在350pxの場所になっています。変更したい場合はfixmenu_pagetop.jsの34行目あたりにある、<br>
offsettop = 350;<br>
の350を変更して下さい。</p>

<h3>現在ページ表示中のメニューについて</h3>
<p>当ページでいえば上部メインメニューの「会社概要」に色がついていますが、その設定の説明です。<br>
通常は、<br>
...
<p><a href="c2.html">こちらにサンプルページがあります。</a></p>
